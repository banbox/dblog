...
export const events = {
    ...
    ArticlePublished: event("0x0072fe24c2bb7820d3181ca0ddc98a946a44d0b02900ac5bd5165ebedb01431d", "ArticlePublished(uint256,address,uint256,string,string,uint256)", {"articleId": indexed(p.uint256), "author": indexed(p.address), "categoryId": indexed(p.uint256), "arweaveId": p.string, "originalAuthor": p.string, "timestamp": p.uint256}),
...
export const functions = {
    ...
    articles: viewFun("0xedcfafe6", "articles(uint256)", {"_0": p.uint256}, {"arweaveHash": p.string, "author": p.address, "originalAuthor": p.string, "categoryId": p.uint64, "timestamp": p.uint64}),
    ...
    publish: fun("0x073b9e26", "publish(string,uint64,uint96,string)", {"_arweaveId": p.string, "_categoryId": p.uint64, "_royaltyBps": p.uint96, "_originalAuthor": p.string}, p.uint256),
